...
port(8081);
console.log(" simpleDB server running , type http://localhost:8081/ , show all list ");
console.log(" simpleDB server running , type http://localhost:8081/add/anyname , add one name into db ");
// set up a database
...
function addName(request){
	...
	console.log(" person name :",request.params.person);
...
function showAll(request){
	...
	function gotNames(names){
		var namestext = "";
		console.log(" db length",names.length);
